...
song_2 = File.open('../Ampafy_Seed/Songs/Home.mp3')
song2 = Song.new(title: 'Home', album_id: album1.id)
song2.audio = song_2
song2.save!

song_3 = File.open('../Ampafy_Seed/Songs/World_Gone_Mad.mp3')
song3 = Song.new(title: 'Home', album_id: album1.id)
song3.audio = song_3
song3.save!
